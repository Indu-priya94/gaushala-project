...
function SevaSection() {
  ...
  const fetchSevas = async () => {
    const res = await axios.get("http://localhost:5000/seva");
    setSevas(res.data);
  };

  const fetchBookings = async () => {
    const res = await axios.get("http://localhost:5000/seva-booking");
  ...
  const addSeva = async () => {
    ...
    await axios.post("http://localhost:5000/seva/add", {
      title,
      description,
      image,
    });
  ...
  const deleteSeva = async (id) => {
    ...
    await axios.delete(`http://localhost:5000/seva/${id}`);
    setCurrent(0);
    fetchSevas();
  };
  ...
  const bookSeva = async () => {
    ...
    await axios.post("http://localhost:5000/seva-booking/add", {
      name: userName,
      phone,
      email,
  ...
  const deleteBooking = async (id) => {
    ...
    await axios.delete(`http://localhost:5000/seva-booking/${id}`);
    fetchBookings();
  };
